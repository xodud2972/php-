                ...
                <div class="col-lg-12">
					...
					?>
                                <tr>
                                    ...
                                    <td><?= $cmt ?></td>
                                    <td>
                                        <a href="../uploads/<?= '파일이름' ?>" download> <?= '파일개수' ?> </a>
                                    </td>
                                    <td>
                                        <a class="btn btn-xs btn-info" type="button" href="../view/select.php?&id=<?= $id ?>"> 자세히 보기 </a>
                                        <a class="btn btn-xs btn-warning" type="button" href="../view/edit.php?&id=<?= $id ?>"> 수정하기 </a>
                                        <a class="btn btn-xs btn-danger" type="button" href="../process/process_del.php?&id=<?= $id ?>">삭제하기</a>
                                    </td>
                                </tr>
                                <?
						}
